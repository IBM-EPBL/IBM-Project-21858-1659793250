...
app.config["DB2_HOSTNAME"] = '9938aec0-8105-433e-8bf9-0fbb7e483086.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud'
app.config["DB2_PORT"] = '32459'
app.config["DB2_PROTOCOL"] = 'TCPIP'
app.config["DB2_USER"] = 'mqs19694'
app.config["DB2_PASSWORD"] = 'SsDjCqU5ECrgxjRF'

Session(app)

# Creates a connection to the database
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=9938aec0-8105-433e-8bf9-0fbb7e483086.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud:32459/bludb:userid=<mqs19694>;password=<r1WNVdtZMECaCyhO>;sslConnection=true;",'','')
